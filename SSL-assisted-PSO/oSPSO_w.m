function [G_Optimal Iter_OptimalResult Time] = oSPSO_w(func_id,xmin,xmax,vmin,vmax,run_times,dimension,popsize,max_evaluations)
% clc
% clear all
% global dimension
% global popsize
...
for r=1:run_times
    ...
    evaltimes_output(1)=evaltimes;
     ...
     neighbor_threshold = ((0.1*(xmax - xmin)^2)*dimension)^0.5;
