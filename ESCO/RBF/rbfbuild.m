function [model, time] = rbfbuild(Xtr, Ytr, bf_type, bf_c, usePolyPart, verbose)
% RBFBUILD
% Builds a Radial Basis Function (RBF) interpolant using training data
%
% Call
%   [model, time] = rbfbuild(Xtr, Ytr, bf_type, bf_c, usePolyPart, verbose)
%   [model, time] = rbfbuild(Xtr, Ytr, bf_type, bf_c, usePolyPart)
%   [model, time] = rbfbuild(Xtr, Ytr, bf_type, bf_c)
%   [model, time] = rbfbuild(Xtr, Ytr, bf_type)
%   [model, time] = rbfbuild(Xtr, Ytr)
%
% Input
