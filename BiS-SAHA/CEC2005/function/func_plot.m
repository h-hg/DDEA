...
for func_num=103:103
    ...
    elseif func_num==101 x=-5:0.1:5; y=x;%a = -5.12; b = 5.12; %[-5.12,5.12]  
    elseif func_num==102 x=-2.048:0.1:2.048; y=x;%a = -2.048; b = 2.048; %[-2.048,2.048]  
    elseif func_num==103 x=-32.768:1:32.768; y=x;%a = -32.768; b = 32.768; %[-32.768,32.768]  
    elseif func_num==104 x=-600:20:600; y=x;%a = -600; b = 600; %[-600,600] 
    elseif func_num==105 x=-5:0.1:5; y=x;%a = -5; b = 5; %[-5,5]  
    end
