...
%
%          * source   : whether data or test points were used.(是否使用数据或测试点)
%          * npoints : number of points.(点的数量)
%          * Ystd     : Standard deviation of data.(数据标准偏差)
%          * Yrange   : Range of data.(数据的范围)
%          * RMSE     : Root mean square error.(均方根误差)
%          * MinE     : Minimum error.(最小误差)
%          * MaxE     : Maximum error.(最大误差)
%          * MAE      : Maximum absolute error.(最大绝对误差)
%          * RMSE     : Relative root mean square error.(相对均方根误差)
%          * MinE     : Relative minimum error.(相对最小误差)
%          * MaxE     : Relative maximum error.(相对最大误差)
%          * MAE      : Relative maximum absolute error.(相对最大绝对误差)
%
%          Fields meaningful only for polynomial response surfaces:
%          * PRS_SE          : Standard error.(标准误差)
%          * PRS_R2          : Coefficient of determination (R-square).(决定系数(r平方))
%          * PRS_R2a         : Adjusted R-square.(调整r平方)
%
